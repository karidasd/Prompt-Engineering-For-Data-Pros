...
## 🚀 How to Use (Πώς να το χρησιμοποιήσεις)

Inside each module, you will find:
1. **Theory (Θεωρία):** A brief explanation of the concept.
2. **The Prompt Template (Το Πρότυπο):** A structured prompt you can copy.
3. **Example (Παράδειγμα):** A real-world scenario of the prompt in action.

Simply open the README of the module you are interested in, copy the prompt, and paste it into ChatGPT, Claude, or your local LLM!
